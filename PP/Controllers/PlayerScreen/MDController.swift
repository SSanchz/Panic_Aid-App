    ...
    var body: some View {
        VStack {
            ...
            Image("Mind")
                ...
                .clipShape(Circle())
                .padding(.all, 8)
                .background(Color(#colorLiteral(red: 1, green: 0.9882352941, blue: 0.8509803922, alpha: 1)))
                .clipShape(Circle())
            ...
            HStack(spacing: 20) {
                Button(action: {}, label: {
                    ModifiedButtonView2(image: "backward.fill")
                })
                ...
                Button(action: {}, label: {
                    ModifiedButtonView2(image: "forward.fill")
                })
            }
            .padding(.top, 25)
...
struct ModifiedButtonView2: View {
    var image: String
