...
//  PP
//
//  Created by user248997 on 4/5/24.
//
    ...
    var body: some View {
        VStack {
            ...
            Image("Ground")
                ...
                .clipShape(Circle())
                .padding(.all, 8)
                .background(Color(#colorLiteral(red: 0.8980392157, green: 0.7333333333, blue: 1, alpha: 1)))
                .clipShape(Circle())
            ...
            HStack(spacing: 20) {
                Button(action: {}, label: {
                    ModifiedButtonView3(image: "backward.fill")
                })
                ...
                Button(action: {}, label: {
                    ModifiedButtonView3(image: "forward.fill")
                })
            }
            .padding(.top, 25)
        ...
        .background(Color(#colorLiteral(red: 0.8980392157, green: 0.7833333333, blue: 1, alpha: 1)))
        .onAppear(perform: {
            setupAudio()
        })
...
struct ModifiedButtonView3: View {
    var image: String
