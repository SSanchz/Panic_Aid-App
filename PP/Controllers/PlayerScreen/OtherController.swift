    ...
    var body: some View {
        VStack {
            ...
            Image("Misc")
                ...
                .clipShape(Circle())
                .padding(.all, 8)
                .background(Color(#colorLiteral(red: 0.9980392157, green: 0.9993333333, blue: 1, alpha: 1)))
                .clipShape(Circle())
            ...
            HStack(spacing: 20) {
                Button(action: {}, label: {
                    ModifiedButtonView4(image: "backward.fill")
                })
                ...
                Button(action: {}, label: {
                    ModifiedButtonView4(image: "forward.fill")
                })
            }
            .padding(.top, 25)
...
struct ModifiedButtonView4: View {
    var image: String
