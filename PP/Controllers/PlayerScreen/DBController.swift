...
struct DBController: View {
    let audioFile = "3MinuteBreathing"
    ...
    var body: some View {
        VStack {
            ...
            Image("DeepB")
                ...
                .clipShape(Circle())
                .padding(.all, 8)
                .background(Color(#colorLiteral(red: 0.8549019608, green: 1, blue: 0.8509803922, alpha: 1)))
                .clipShape(Circle())
            ...
            HStack(spacing: 20) {
                ...
                Button {} label: {
                    Image(systemName: isplaying ? "pause.fill" : "play.fill")
                        ...
                        .background(
                            ZStack {
                                Color(#colorLiteral(red: 0.8549019608, green: 1, blue: 0.8509803922, alpha: 1))
                            ...
                            .clipShape(Circle())
                            .shadow(color: Color(#colorLiteral(red: 0.8549019608, green: 1, blue: 0.8509803922, alpha: 1)), radius: 20, x: 20, y: 20)
